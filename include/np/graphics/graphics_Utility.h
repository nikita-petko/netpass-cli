#ifndef NP_GRAPHICS_GRAPHICS_UTILITY_H_
#define NP_GRAPHICS_GRAPHICS_UTILITY_H_
...
namespace np { namespace graphics {
	...
	*/
	...
	/*!
		@brief This macro prints the error type to debug output and calls the NN_TPANIC_ function if a GL error occurs.
	*/

#define GRAPHICS_ASSERT_GL_ERROR()                 \
	{                                              \
		GLenum errorCode = glGetError();           \
		if (errorCode != GL_NO_ERROR)              \
		{                                          \
			np::graphics::PrintGLError(errorCode); \
			NN_TPANIC_("\n");                      \
		}                                          \
	}

#define GRAPHICS_FORCE_LINK_APPLET_LIB()           \
	{                                              \
